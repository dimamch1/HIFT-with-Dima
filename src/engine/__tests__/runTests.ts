...
import { WorkoutLogEntry } from '../../types/index';

console.log('====================================================');
console.log('🏋️ CROSSFIT & HIFT APP - CORE ENGINE TEST SUITE');
console.log('====================================================\n');
...
// -------------------------------------------------------------
assert(MOVEMENT_DATABASE.length >= 10, 'Movement database contains all core HIFT movements');
...
assert(
  (thruster?.substitutions.length ?? 0) > 0,
